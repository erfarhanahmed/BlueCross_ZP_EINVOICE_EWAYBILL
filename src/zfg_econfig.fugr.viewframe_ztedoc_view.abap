*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZTEDOC_VIEW
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZTEDOC_VIEW         .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZTEDOC_VIEW'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZTEDOC_VIEW_EXTRACT
TOTAL = ZTEDOC_VIEW_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZTEDOC_VIEW'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZTEDOC_VIEW-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZTEDOC_VIEW_EXTRACT
TOTAL = ZTEDOC_VIEW_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZTEDOC_VIEW-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZTEDOC_VIEW'
...
TOTAL = ZTEDOC_VIEW_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZTEDOC_VIEW-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZTEDOC_VIEW-UPD_FLAG NE SPACE.
