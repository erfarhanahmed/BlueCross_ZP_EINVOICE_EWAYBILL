*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVEINV_DOCTYP
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVEINV_DOCTYP       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVEINV_DOCTYP'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVEINV_DOCTYP_EXTRACT
TOTAL = ZVEINV_DOCTYP_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVEINV_DOCTYP'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVEINV_DOCTYP-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVEINV_DOCTYP_EXTRACT
TOTAL = ZVEINV_DOCTYP_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVEINV_DOCTYP-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVEINV_DOCTYP'
...
TOTAL = ZVEINV_DOCTYP_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVEINV_DOCTYP-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVEINV_DOCTYP-UPD_FLAG NE SPACE.
