*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVEINV_APPVR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVEINV_APPVR        .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVEINV_APPVR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVEINV_APPVR_EXTRACT
TOTAL = ZVEINV_APPVR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVEINV_APPVR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVEINV_APPVR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVEINV_APPVR_EXTRACT
TOTAL = ZVEINV_APPVR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVEINV_APPVR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVEINV_APPVR'
...
TOTAL = ZVEINV_APPVR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVEINV_APPVR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVEINV_APPVR-UPD_FLAG NE SPACE.
