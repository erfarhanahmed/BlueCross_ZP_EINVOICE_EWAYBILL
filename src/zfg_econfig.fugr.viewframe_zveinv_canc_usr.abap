*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVEINV_CANC_USR
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVEINV_CANC_USR     .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVEINV_CANC_USR'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVEINV_CANC_USR_EXTRACT
TOTAL = ZVEINV_CANC_USR_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVEINV_CANC_USR'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVEINV_CANC_USR-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVEINV_CANC_USR_EXTRACT
TOTAL = ZVEINV_CANC_USR_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVEINV_CANC_USR-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVEINV_CANC_USR'
...
TOTAL = ZVEINV_CANC_USR_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVEINV_CANC_USR-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVEINV_CANC_USR-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZVEINV_CANC_USR'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZVEINV_CANC_USR-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVEINV_CANC_USR_EXTRACT
TOTAL = ZVEINV_CANC_USR_TOTAL
