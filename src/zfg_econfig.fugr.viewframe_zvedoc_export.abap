*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVEDOC_EXPORT
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVEDOC_EXPORT       .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVEDOC_EXPORT'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVEDOC_EXPORT_EXTRACT
TOTAL = ZVEDOC_EXPORT_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVEDOC_EXPORT'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVEDOC_EXPORT-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVEDOC_EXPORT_EXTRACT
TOTAL = ZVEDOC_EXPORT_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVEDOC_EXPORT-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVEDOC_EXPORT'
...
TOTAL = ZVEDOC_EXPORT_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVEDOC_EXPORT-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVEDOC_EXPORT-UPD_FLAG NE SPACE.
