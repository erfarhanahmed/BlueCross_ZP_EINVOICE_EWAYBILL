*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZMV_STATE_CODE
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZMV_STATE_CODE      .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZMV_STATE_CODE'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZMV_STATE_CODE_EXTRACT
TOTAL = ZMV_STATE_CODE_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZMV_STATE_CODE'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZMV_STATE_CODE-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_STATE_CODE_EXTRACT
TOTAL = ZMV_STATE_CODE_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZMV_STATE_CODE-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZMV_STATE_CODE'
...
TOTAL = ZMV_STATE_CODE_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZMV_STATE_CODE-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZMV_STATE_CODE-UPD_FLAG NE SPACE.
...
CALL FUNCTION 'VIEWPROC_ZMV_STATE_CODE'
                    ...
                    IMPORTING
                              UPDATE_REQUIRED =
STATUS_ZMV_STATE_CODE-UPD_FLAG
                    TABLES
                        EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZMV_STATE_CODE_EXTRACT
TOTAL = ZMV_STATE_CODE_TOTAL
